...
HTML_TAIL = '''
<script>
function showPage(pageId){document.querySelectorAll(".page").forEach(p=>p.classList.remove("active"));document.getElementById("page-"+pageId).classList.add("active");document.querySelectorAll(".nav-links a").forEach(a=>a.classList.remove("active"));var navLink=document.getElementById("nav-"+pageId);if(navLink)navLink.classList.add("active");window.scrollTo(0,0);if(pageId==="products")setTimeout(initProductFilters,100)}
function toggleMobileMenu(){document.getElementById("mobileMenu").classList.toggle("open")}
function toggleDetail(el){var panel=el.nextElementSibling;if(panel.classList.contains("open")){panel.classList.remove("open");el.querySelector(".toggle-icon").textContent="+";el.querySelector(".toggle-text").textContent="查看详细参数"}else{panel.classList.add("open");el.querySelector(".toggle-icon").textContent="-";el.querySelector(".toggle-text").textContent="收起详细参数"}}
function initProductFilters(){var filterBtns=document.querySelectorAll(".filter-btn");filterBtns.forEach(function(btn){btn.addEventListener("click",function(){filterBtns.forEach(b=>b.classList.remove("active"));this.classList.add("active");var cat=this.dataset.cat;var cards=document.querySelectorAll(".product-full-card");cards.forEach(function(card){if(cat==="all"||card.dataset.cat===cat){card.style.display="block"}else{card.style.display="none"}})})})}
window.addEventListener("scroll",function(){var nav=document.getElementById("mainNav");if(window.scrollY>50){nav.classList.add("scrolled")}else{nav.classList.remove("scrolled")}});
...
nav = '''
  <nav class="nav" id="mainNav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="#" onclick="showPage('care'); return false;" id="nav-care" class="care-link">ITO CARE</a></li>
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <a href="#" onclick="showPage('care'); toggleMobileMenu(); return false;">ITO CARE</a>
        ...
        <div class="care-hero fade-in">
          <div class="care-hero-content">
            ...
            <div class="care-hero-actions">
              <a href="#" class="btn btn-care btn-arrow" onclick="showPage('care'); return false;">了解服务详情</a>
      ...
      <div class="footer-top">
        ...
        <div>
          ...
          <ul class="footer-links">
            ...
            <li><a href="#" onclick="showPage('care'); return false;">ITO CARE</a></li>
